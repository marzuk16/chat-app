...
class WebCookieJwtFilterTest {
    ...
    @Test
    void validCookieToken_setsSecurityContext() throws Exception {
    ...
    @Test
    void missingCookie_returnsUnauthorized() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.setRequestURI("/dashboard");
        MockHttpServletResponse response = new MockHttpServletResponse();
    ...
    @Test
    void wrongCookieName_returnsUnauthorized() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.setRequestURI("/dashboard");
        request.setCookies(new Cookie("session", "some.token.value"));
        MockHttpServletResponse response = new MockHttpServletResponse();
